...
<AppShell>
	...
	<div class="container h-full mx-auto flex justify-center items-center">
		<div class="space-y-10 text-center flex flex-col items-center">
			<h2 class="h2">Collaboration Through Transparency</h2>
			<!-- Animated Logo -->
			<figure>
			...
			<p class="p w-3/4 h3 font-semibold">
				Candor will keep track of applications and their status, provide personalized statistics,
				and recommend opportunities that haven’t yet been applied for!
			</p>
